  ...
  try {
    geminiStream = await ai.models.generateContentStream({
      ...
      config: {
        systemInstruction:
          mode === "general"
            ? SYSTEM_PROMPT + STATS_AND_FORMAT_SUFFIX
            : SYSTEM_PROMPT + MODE_SECTION_PROMPTS[mode] + STATS_AND_FORMAT_SUFFIX,
        tools: [{ googleSearch: {} }],
      },
    });
  } catch (err) {
